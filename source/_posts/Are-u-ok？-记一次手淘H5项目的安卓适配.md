---
title: Are u ok？---记一次手淘H5项目的安卓适配
date: 2015-05-07 17:36:52
tags: H5 适配 无线
---
...
我问@顺堂，调试神器--[MDS调试平台](http://mds.taobao.net/)能不能调，顺堂居然羞涩地低下了头：安卓4.4以下的确实不行呢。因为devtool....（广告费你懂的）
...
还好我们有[kimi](http://fed.taobao.net/)提供的解决方案（真的不是广告）
...
[更多资料可以看这里](
http://gitlab.alibaba-inc.com/tbc/m-base/blob/master/1px.md)
...
想不通，看m-base源码是怎么算的吧。
搜索gitlab代码库找到m-base，运气不错，很快就搜到了相关代码
...
此文也发表于淘宝前端团队博客[地址](http://www.taobaofed.org/blog/2015/10/28/auto-layout-in-h5-project/)
